...
program_version_link="https://ghproxy.com/https://raw.githubusercontent.com/amn5di55/onekey-install-shell/master/frps/version.sh"
str_install_shell=https://ghproxy.com/https://raw.githubusercontent.com/amn5di55/onekey-install-shell/master/frps/install-frps.sh
shell_update(){
    fun_clangcn "clear"
